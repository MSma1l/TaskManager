  ...
  return (
    <div className="px-4 pt-5 max-w-[1600px] mx-auto">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold tracking-tight">Saptamana</h1>
      ...
      <div className="flex items-center justify-between mb-5">
        <button
          onClick={handlePrev}
          className="p-2.5 rounded-xl bg-slate-800 hover:bg-slate-700 border border-slate-700/50 transition-all duration-200 hover:scale-105 active:scale-95"
        >
