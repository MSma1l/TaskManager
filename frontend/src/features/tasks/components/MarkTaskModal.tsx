        ...
        <div className="bg-slate-800 rounded-2xl p-6 w-full max-w-sm border border-slate-700" onClick={(e) => e.stopPropagation()}>
          ...
          <div className="flex flex-col gap-2">
            ...
            {onEdit && (
              <button
                onClick={() => onEdit(task)}
                className="w-full py-2.5 rounded-xl text-blue-400 hover:bg-blue-900/30 text-sm font-medium transition-colors flex items-center justify-center gap-2"
              >
                ...
                <div className="border-t border-slate-700 mt-1 pt-3 flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-3">
                    {onEdit && (
                      <button
                        onClick={() => onEdit(task)}
                        className="text-blue-400/60 hover:text-blue-400 text-sm transition-colors flex items-center gap-1.5"
                      >
